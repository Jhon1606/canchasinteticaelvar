...
<body class="hold-transition sidebar-mini layout-fixed">
            ...
            <div class="collapse d-lg-block" id="sidebarMenu">
                <div class="sidebar">
                    ...
                    <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu">
                        <li class="nav-item">
                            <a href="canchas.php" class="nav-link active">
        ...
        <div class="content-wrapper">
            <div class="container-fluid">
                ...
                <div class="table-responsive"> <!-- Asegura que la tabla sea responsive -->
                    <table id="canchasTable" class="table table-striped">
                        <thead>
                            <tr>
                                <th>Nombre</th>
    ...
    <script>
        $(document).ready(function() {
            $('#canchasTable').DataTable(); // Inicializa DataTables
        });
    </script>
    <script>
        $(document).ready(function() {
            var table = $('#canchasTable').DataTable();
            $.ajax({
                ...
                success: function(response) {
                    ...
                    table.clear();
                    $.each(data, function(index, cancha) {
                        table.row.add([
                            cancha.nombre,
                            cancha.fecha_registro
                        ]).draw(false);
                    });
                },
